export const projects = [
  {
    ...
    description: [
      "This is my portfolio page (the one that you're currently on.) The front end is built using Gatsby.js, which pulls from my personal api that is handled by Node/Express.js.",
